...
{
	uint16_t pos;
	copysave(&pos,this->raw_pitch_enc,2);
...
{
	uint16_t pos;
	copysave(&pos,this->raw_yaw_enc,2);
...
void sensors::init_chain()
{
	...
	this->chain[1].regArd 	= 0x21;
	this->chain[1].dataSize 	= 2;
	this->chain[1].period   	= 1000/100; // 100hz
	this->chain[1].cnt		= 0;


	this->chain[2].bufAdr 	= &this->raw_yaw_enc;
	this->chain[2].busAdr 	= 0x31;
	this->chain[2].regArd 	= 0x21;
	this->chain[2].dataSize = 2;
	this->chain[2].period   = 1000/100; // 100hz
	this->chain[2].cnt		= 0;
